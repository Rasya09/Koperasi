    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="place section" id="place">
                <h2 class="section__title">Select Product</h2>

                <div class="place__container container grid">
                    <!--==================== PLACES CARD 1 ====================-->
                    <div class="place__card">
                        <img src="{{  asset('assetslp/img/place1.jpg') }}" alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 2 ====================-->
                    <div class="place__card">
                        <img src="{{  asset('assetslp/img/place2.jpg') }}" alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 3 ====================-->
                    <div class="place__card">
                        <img src="{{  asset('assetslp/img/place3.jpg') }}" alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 4 ====================-->
                    <div class="place__card">
                        <img src="{{  asset('assetslp/img/place4.jpg') }}" alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 5 ====================-->
                    <div class="place__card">
                        <img src="{{  asset('assetslp/img/place5.jpg') }}" alt="" class="place__img">
            ...
            <div class="footer__container container grid">
                <div class="footer__content grid">
                    <div class="footer__data">
                        ...
                        <p class="footer__description">SMK Taruna Bhakti <br> adalah salah satu SMK di Kota Depok <br> dengan status Terakreditasi “ A “
                        </p>
                        <div>
