            ...
            <form class="form-horizontal" method="POST" action="/admin/tambahproduk" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="file" class="form-control" id="fname" placeholder="" name="image" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="lname" placeholder="Description" name="desc" />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="email1" placeholder="Price" name="price" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="number" class="form-control" id="email1" placeholder="Stock" name="stock" />
                      </div>
                  </div>
